    ...
    <>
      ...
      <div className="w-full min-h-screen bg-[#070312] flex flex-col lg:flex-row items-center justify-center p-6 gap-10">
        ...
        <div className="max-w-lg text-center lg:text-left">
          <h1 className="text-white text-2xl pb-5">
            Know <span className="text-[#A78BFA]">Who I'M</span>
          </h1>
          <p className="text-white text-lg leading-relaxed">
            Hello! I am Bilal Ahmed, a <span className="text-[#A78BFA]">Hafiz-e-Quran, Alim-e-Deen, and a MERN Stack Developer</span>
            passionate about crafting modern and user-friendly web interfaces. Proficient in
            <span className="text-[#A78BFA]"> HTML, CSS, JavaScript, React.js, Next.js, Node.js, and Tailwind CSS</span>, I combine creativity
        ...
        {/* Image Section */}
        <div>
          <img className="w-72 md:w-96 h-auto" src={img} alt="Bilal Ahmed" />
        </div>
      </div>
      ...
      <div className="bg-[#070312] px-6 md:px-20 text-center md:text-left">
        <h1 className="text-2xl text-white">
          My <span className="text-[#A78BFA]">Expertise</span>
        </h1>
      ...
      <div className="bg-[#070312] py-10 px-6 text-center">
        <h1 className="text-2xl text-[#A78BFA]">
          Skills <span className="text-white">&</span> Proficiencies
        </h1>
        <div className="flex flex-wrap justify-center gap-6 mt-6">
          {[
            { icon: <FaHtml5 className='text-[#A78BFA] text-6xl' />, name: "HTML" },
            { icon: <SiCss3 className='text-[#A78BFA] text-6xl' />, name: "CSS" },
            { icon: <IoLogoJavascript className='text-[#A78BFA] text-6xl' />, name: "JavaScript" },
            { icon: <FaBootstrap className='text-[#A78BFA] text-6xl' />, name: "Bootstrap" },
            { icon: <FaReact className='text-[#A78BFA] text-6xl' />, name: "React.js" },
            { icon: <SiNextdotjs className='text-[#A78BFA] text-6xl' />, name: "Next.js" },
            { icon: <RiTailwindCssFill className='text-[#A78BFA] text-6xl' />, name: "Tailwind CSS" },
            { icon: <SiExpress className='text-[#A78BFA] text-6xl' />, name: "Express.js" }
          ].map((skill, index) => (
            <div key={index} className="w-40 border border-[#A78BFA] h-28 rounded-lg flex flex-col items-center justify-center transform hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer">
              {skill.icon}
